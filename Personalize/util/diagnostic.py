"""Diagnostic/exploratory utilities for Personalize recommender datasets"""
...
def analyze(df, users=None, items=None):
    print("########################################")
