...
this.state={
    ...
    async componentDidMount(){
        ...
        let productDetailsUrl=config.api.GetDetailsUrl + this.props.match.params.id;
        ...
        .then(data=>{
           ...
           this.setState({ showAMZNLink:(data.Items.length>0), description:data.Items});
        });
    }catch (e){
    ...
    render(){
        ...
        if (item!=undefined)
        {
            ...
            if (uid!=null)
            {
                ...
                <div className="itemsForUser">
                    ...
                    <div>
                        <RecommendationList mode="ItemsForUser" userId={uid?.toString()} ></RecommendationList>
                    </div>
                 </div>);
            }
           ...
           let amazonLinkContent=this.state.showAMZNLink?( <tr><td></td>
            <td>
            <a target="_blank" href={amazonUrl}>Buy it on Amazon.com</a></td></tr>):
            (<tr><td></td></tr>);
        ...
        return (
            ...
            <div>
               <table className="productDetail" key={item.asin}><tbody><tr><td>
                  <img src= {item.imUrl}></img>
                   </td><td>
                       <b>{htmlEntities.decode(item.title)}</b><br/>
                   ...
                   <div className="similar">
                       ...
                       <div>
                            <RecommendationList mode="SimilarItems" userId={uid?.toString()} productId={item.asin} ></RecommendationList>
                       </div>
                   </div>
               {recommendedForUser}
        ...
        return (<div><h1>Could not load product.</h1></div>)
    }
    }
}
