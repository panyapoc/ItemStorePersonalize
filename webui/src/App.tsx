...
class App extends React.Component<RouteComponentProps<AppProps>, AppState> {
  ...
  showLoggedInBar = () => <Fragment></Fragment>;

  showLoggedOutBar = () => <Fragment></Fragment>;
  ...
  handleUserSelectChange(userId: any) {
    ...
    if (user != null) {
      if (user.firstName != null) {
        this.setState({
          userSelectedName: user?.firstName + " " + user?.lastName
        });
      }
    }
            ...
            <Navbar.Brand>
              <Link to="/">
                <span className="orange">
                  {" "}
                  <img src="../img/shop.png" alt="bookstore" />
                  The All Store - Great Prices, Huge Collection
                </span>
              </Link>
            </Navbar.Brand>
            <Navbar.Toggle />
        ...
        <Router>
          <div>
            <Switch>
              <Route exact path="/">
                <Select
                  value={this.state.userSelectedName}
                  onChange={(e: React.ChangeEvent<{ value: any }>) =>
                    this.handleUserSelectChange(e.target.value)
                  }
                >
